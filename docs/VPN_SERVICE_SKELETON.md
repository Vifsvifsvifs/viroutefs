...
The normal Networks screen does not expose TEST-NET controls. The safe route remains available only under Settings → Developer diagnostics for explicit internal/developer testing.
