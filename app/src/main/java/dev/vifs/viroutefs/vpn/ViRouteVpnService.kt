...
/**
 * Safe ViRouteFS TUN runtime skeleton for 0.8.0-alpha.
 *
 ...
 * or real VPN engines are enabled. The packet loop parses only IPv4 header metadata for local TCP/UDP/ICMP counters and drops every packet.
 */
